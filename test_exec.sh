...
python FastenStaticAnalyzer.py --source="test/test_system_call_3/test.c" --preprocessor="gcc" --preprocessor_args="-std=c99 -nostdinc -E -D_Atomic(_arg)=_arg -Ipycparser/utils/fake_libc_include" --delete_temporary_files --export_file=bla_result_2.txt
